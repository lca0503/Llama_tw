...
from utils.train_utils import WeightLossTrainer
from utils.other_utils import important_ids
from utils.model_utils import WeightLossLlamaForCausalLM
...
def main(**kwargs):
    ...
    # Prepare Model
    model = WeightLossLlamaForCausalLM.from_pretrained(train_config.model_name)
    ...
    loss_weight =  [1000.0 if i in important_ids else 1.0 for i in range(model.config.vocab_size)]
